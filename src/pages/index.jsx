...
import rainbowShoes from "../public/rainbowShoes.png";
		...
		<div>
			<header>
				<section id={indexStyles.start}>
					...
					<div id={indexStyles.cover}>
						<form /* onSubmit={return false} */>
							{" "}
							{/* onSubmit is weird with returns i'm probably missing something */}
				...
				<nav className={indexStyles.flexContainer}>
					...
					<a id="cslink" href="cart-wishlist.html">
						{" "}
						{/* <i className="material-icons"
                    style="font-size:40px;color:#3de1b3;">shopping_basket</i> */}
					</a>
			...
			<main>
				<section /* id="just-in" this is useless*/>
					...
					<div id={indexStyles.textFp}>
						...
						<Link id={indexStyles.clickHere} to="./easter" /* TODO: later */>
							Click here to buy
						</Link>
					</div>
					<h2>Recommended</h2>
